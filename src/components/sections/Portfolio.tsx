    ...
    <section className="py-24 bg-background">
      <div className="container px-4 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
          ...
          <Button variant="outline" className="glass border-white/10">View Full Portfolio</Button>
        </div>
          ...
          {demos.map((demo, index) => {
            ...
            return (
              <div key={index} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-12 group`}>
                <div className="w-full lg:w-3/5 overflow-hidden rounded-3xl glass border-white/10 glow-border group-hover:border-primary/30 transition-all duration-700">
                ...
                <div className="w-full lg:w-2/5">
                  ...
                  <Button className="rounded-full px-8 group">
                    ...
                    <ExternalLink className="ml-2 w-4 h-4 opacity-0 group-hover:opacity-100 transition-all -translate-x-2 group-hover:translate-x-0" />
                  </Button>
                </div>
              </div>
            );
